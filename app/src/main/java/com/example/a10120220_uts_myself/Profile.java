...
//        });
        instagram.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                gotoUrl("https://instagram.com/fahmiiasdk?igshid=MzNlNGNkZWQ4Mg==");
            }
        });
    ...
    public void ClickDaily(View view) {
        //redirect to gallery
        HomeActivity.redirectActivity(this, com.example.a10120220_uts_myself.Daily.class);
    }
    ...
    public static void About(final Activity activity) {
        ...
        //set message
        builder.setMessage("BDR v1.0 This App Contains Personal Data About Fahmi Anwar S");
    ...
    public void onButtonTap(View v) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"fahmierror26@gmail.com"});
    ...
    public void callClick(View view) {
        ...
        intentCall.setData(Uri.parse("tel:08977844259"));
