...
public class WalkThrough1 extends AppCompatActivity {
    ...
    private com.example.a10120220_uts_myself.OnBoardingAdapter onBoardingAdapter;
        ...
        OnBoardingAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(onBoardingViewPager.getCurrentItem() + 1 < onBoardingAdapter.getItemCount()){
                    ...
                    startActivity(new Intent(getApplicationContext(), com.example.a10120220_uts_myself.HomeActivity.class));
                    finish();
                }
            }
        });
    ...
    private void setupOnBoardingItems(){
        List<com.example.a10120220_uts_myself.OnBoardingItem> onBoardingItems = new ArrayList<>();
        com.example.a10120220_uts_myself.OnBoardingItem item1 = new com.example.a10120220_uts_myself.OnBoardingItem();
        item1.setTittle("Hi, there!");
        item1.setDescription("Welcome to My Self Apps");
        item1.setImage(R.drawable.ic_welcome);

        com.example.a10120220_uts_myself.OnBoardingItem item2 = new com.example.a10120220_uts_myself.OnBoardingItem();
        ...
        com.example.a10120220_uts_myself.OnBoardingItem item3 = new com.example.a10120220_uts_myself.OnBoardingItem();
        ...
        onBoardingAdapter = new com.example.a10120220_uts_myself.OnBoardingAdapter(onBoardingItems);
    }
