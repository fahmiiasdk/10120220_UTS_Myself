...
public class OnBoardingAdapter extends  RecyclerView.Adapter<OnBoardingAdapter.OnBoardingViewHolder> {
    ...
    private List<com.example.a10120220_uts_myself.OnBoardingItem> onBoardingItemList;

    public OnBoardingAdapter(List<com.example.a10120220_uts_myself.OnBoardingItem> onBoardingItemList) {
    ...
    class OnBoardingViewHolder extends RecyclerView.ViewHolder{
        ...
        void setOnBoardingData(com.example.a10120220_uts_myself.OnBoardingItem onBoardingItem){
